...
final List<Question> questions = [
  ...
  Question(
    cat: Category.food,
    question:
        'كم عدد الوجبات التي يطبخها والداك أسبوعياً (بما في ذلك الوجبات التي تأخذها إلى المدرسة)؟ (تنبيه: البيتزا أو التونة المعلبة لا تُحتسب!)',
  ...
  Question(
    cat: Category.food,
    question:
        'عندما يشتري والداك الطعام، هل يختارون قدر الإمكان المنتجات المحلية (التي لا تأتي من مقاطعة أخرى أو بلد آخر)؟',
  ...
  Question(
    cat: Category.goods,
    question:
        'هل اشترى والداك سلعاً منخفضة استهلاك الطاقة خلال الـ 12 شهراً الماضية (مصابيح اقتصادية، أجهزة كهربائية، إلخ)؟',
    options: ["نعم", "لا"],
  ...
  Question(
    ...
    options: [
      "دراجة هوائية",
      ' "سيارة صغيرة الحجم أو "سوبر ميني',
      'سيارة متوسطة الحجم أو مدمجة (Compact) ',
      "سيارة كبيرة الحجم",
      " سيارة دفع رباعي (SUV) أو ميني فان",
      "شاحنة صغيرة (Pick-up)",
      'لا يوجد',
    ],
  ...
  Question(
    ...
    options: [
      "بالسيارة",
      "بوسائل النقل العام (حافلة، مترو، قطار الضواحي، إلخ)",
      "بحافلة المدرسة",
      "مشياً على الأقدام",
  ...
  Question(
    cat: Category.waste,
    question:
        "هل تقوم عائلتك بإعادة استغلال الصحف، الكرتون، الورق، العلب المعدنية، الزجاجات البلاستيكية أو الزجاجية والمواد الأخرى؟",
    options: ["دائماً", "أحياناً", "نادراً", "أبداً"],
